...
urlpatterns = [
    ...
    path('cuentas-cobrar/<int:pk>/editar/', views.cxc_edit, name='cxc_edit'),
    ...
    path('cuentas-pagar/<int:pk>/editar/', views.cxp_edit, name='cxp_edit'),
    ...
    path('movimientos/nuevo/', views.movimiento_tesoreria_create, name='movimiento_tesoreria_create'),
]