...
CREATE USER erp_user WITH
    PASSWORD 'Erp$2025#Textil'
    CREATEDB
    NOSUPERUSER
    NOCREATEROLE;

-- Otorgar privilegios
GRANT ALL PRIVILEGES ON DATABASE erp_textil TO erp_user;
...
INSERT INTO produccion_categoria_producto_terminado (nombre, descripcion) VALUES
    ('Telas y avíos',             'Materias primas y accesorios para confección textil'),
    ('Telas planas',             'Popelina, Oxford, gabardina y telas técnicas'),
    ('Tejidos de punto',         'Jersey, piqué, rib y tejidos elásticos'),
    ('Uniformes',                'Uniformes corporativos, escolares y deportivos'),
    ('Prendas terminadas',       'Camisas, pantalones, chaquetas y otras prendas'),
    ('Accesorios textiles',      'Gorras, bolsos, bordados y complementos'),
    ('Ropa de protección',       'Prendas de seguridad y uso industrial'),
    ('Dotaciones institucionales','Líneas de dotación para empresas e instituciones');

-- Categorías de materia prima
INSERT INTO produccion_categoria_materia_prima (nombre, descripcion) VALUES
    ('Telas',               'Telas por composición, ancho, gramaje y color'),
    ('Hilos',               'Hilos de coser, bordar y remallar'),
    ('Avíos',               'Botones, cierres, elásticos, broches y hebillas'),
    ('Tintes y acabados',   'Insumos para coloración y acabados textiles'),
    ('Etiquetas',            'Etiquetas de marca, talla y composición'),
    ('Empaques',             'Bolsas, cajas y materiales para despacho'),
    ('Patrones y moldes',   'Materiales y consumibles para corte y confección');
